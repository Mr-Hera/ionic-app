...
const List: React.FC = () => {
    ...
    return (
        <IonPage ref={page}>
            ...
            <IonContent>
                <IonRefresher slot='fixed' onIonRefresh={e => refresh(e)}>
                    <IonRefresherContent />
                </IonRefresher>
                ...
                <IonModal 
                    ...
                    ref={modal} isOpen={selectedUser != null} onIonModalDidDismiss={() => setSelectedUser(null)}
                >
                    <IonHeader>
                        <IonToolbar color={'success'}>
                            <IonButtons slot='start'>
